...
CATCH_TEST_CASE("fixed, length_squared1")
{
  ...
  CATCH_REQUIRE(q.size() == 4);
  CATCH_CHECK(cml::length_squared(q) == Approx(30.).epsilon(.0001));
}
...
CATCH_TEST_CASE("fixed, length1")
{
  cml::quaterniond q = { 1., 2., 3., 4. };
  CATCH_REQUIRE(q.size() == 4);
  CATCH_CHECK(cml::length(q) == Approx(std::sqrt(30.)).epsilon(.0001));
}
...
CATCH_TEST_CASE("fixed, norm1")
{
  cml::quaterniond q = { 1., 2., 3., 4. };
  CATCH_REQUIRE(q.size() == 4);
  CATCH_CHECK(cml::norm(q) == Approx(30.).epsilon(.0001));
}
...
CATCH_TEST_CASE("fixed, log1")
{
  ...
  CATCH_REQUIRE(q.size() == 4);
  auto lnq = cml::log(q);
  CATCH_CHECK(lnq[0] == Approx(0.200991168205).epsilon(.001));
  CATCH_CHECK(lnq[1] == Approx(0.401982336411).epsilon(.001));
  CATCH_CHECK(lnq[2] == Approx(0.602973504616).epsilon(.001));
  CATCH_CHECK(lnq[3] == Approx(1.700598690831).epsilon(.001));
}
...
CATCH_TEST_CASE("fixed, log2")
{
  ...
  CATCH_REQUIRE(q.size() == 4);
  auto lnq = cml::log(q);
  CATCH_CHECK(lnq[0] == Approx(1.700598690831).epsilon(.001));
  CATCH_CHECK(lnq[1] == Approx(0.515190292664).epsilon(.001));
  CATCH_CHECK(lnq[2] == Approx(0.772785438996).epsilon(.001));
  CATCH_CHECK(lnq[3] == Approx(1.030380585328).epsilon(.001));
}
...
CATCH_TEST_CASE("fixed, exp1")
{
  ...
  CATCH_REQUIRE(q.size() == 4);
  auto lnq = cml::exp(q);
  CATCH_CHECK(lnq[0] == Approx(-8.24002526676).epsilon(.001));
  CATCH_CHECK(lnq[1] == Approx(-16.4800505335).epsilon(.001));
  CATCH_CHECK(lnq[2] == Approx(-24.7200758003).epsilon(.001));
  CATCH_CHECK(lnq[3] == Approx(-45.0598020134).epsilon(.001));
}
...
CATCH_TEST_CASE("fixed, exp2")
{
  ...
  CATCH_REQUIRE(q.size() == 4);
  auto lnq = cml::exp(q);
  CATCH_CHECK(lnq[0] == Approx( 1.69392272368).epsilon(.001));
  CATCH_CHECK(lnq[1] == Approx(-0.78955962454).epsilon(.001));
  CATCH_CHECK(lnq[2] == Approx(-1.18433943681).epsilon(.001));
  CATCH_CHECK(lnq[3] == Approx(-1.57911924908).epsilon(.001));
}
