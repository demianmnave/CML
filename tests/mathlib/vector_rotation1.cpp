...
{
  auto vx = cml::rotate_vector(cml::vector3d(0., 1., 0.),
    cml::vector3d(1., 0., 0.), cml::rad(90.));
  ...
  auto vy = cml::rotate_vector(cml::vector3d(-1., 0., 0.),
    cml::vector3d(0., 1., 0.), cml::rad(90.));
  ...
  auto vz = cml::rotate_vector(cml::vector3d(1., 0., 0.),
    cml::vector3d(0., 0., 1.), cml::rad(90.));
