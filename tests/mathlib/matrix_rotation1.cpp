...
{
  cml::matrix33d Mx;
  cml::matrix_rotation_world_x(Mx, cml::rad(90.));
  ...
  cml::matrix33d My;
  cml::matrix_rotation_world_y(My, cml::rad(90.));
  ...
  cml::matrix33d Mz;
  cml::matrix_rotation_world_z(Mz, cml::rad(90.));
...
{
  cml::matrix33d M;
  cml::matrix_rotation_euler(M, cml::rad(90.), 0., 0., cml::euler_order_xyz);
...
{
  cml::matrix33d M;
  cml::matrix_rotation_euler_derivatives(M, 0, cml::rad(90.), 0., 0.,
    cml::euler_order_xyz);
...
{
  cml::matrix33d M;
  cml::matrix_rotation_euler(M, cml::vector3d(cml::rad(90.), 0., 0.),
    cml::euler_order_xyz);
...
{
  cml::matrix33d M;
  cml::matrix_rotation_euler_derivatives(M, 0,
    cml::vector3d(cml::rad(90.), 0., 0.), cml::euler_order_xyz);
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_axis_angle(q, cml::vector3d(1., 0., 0.),
    cml::rad(90.));
  cml::matrix33d M;
...
{
  cml::matrix33d M;
  cml::matrix_rotation_align(M, cml::vector3d(0., 0., 1.),
    cml::vector3d(1., 0., 0.));
  auto v = M * cml::vector3d(0., 1., 0.);  // 0,0,1
  CATCH_CHECK(v[0] == Approx(1.).epsilon(1e-12));
  CATCH_CHECK(0 == Approx(v[1]).epsilon(0).margin(1e-7));
...
{
  cml::matrix33d M;
  cml::matrix_rotation_aim_at(M, cml::vector3d(0., 0., 0.),
    cml::vector3d(0., 0., 1.), cml::vector3d(1., 0., 0.));
  auto v = M * cml::vector3d(0., 1., 0.);  // 0,0,1
  CATCH_CHECK(v[0] == Approx(1.).epsilon(1e-12));
  CATCH_CHECK(0 == Approx(v[1]).epsilon(0).margin(1e-7));
  CATCH_CHECK(0 == Approx(v[2]).epsilon(0).margin(1e-7));
...
{
  cml::matrix33d M;
  cml::matrix_rotation_axis_angle(M, cml::vector3d(1., 2., 3.).normalize(),
    cml::rad(23.));
...
{
  cml::matrix33d M;
  cml::matrix_rotation_euler(M, cml::rad(22.), cml::rad(10.), cml::rad(89.9),
    cml::euler_order_xyz);
