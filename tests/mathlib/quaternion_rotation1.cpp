...
{
  cml::quaterniond qx;
  cml::quaternion_rotation_world_x(qx, M_PI / 3.);
  ...
  cml::quaterniond qy;
  cml::quaternion_rotation_world_y(qy, M_PI / 2.);
  ...
  cml::quaterniond qz;
  cml::quaternion_rotation_world_z(qz, M_PI);
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_axis_angle(q, cml::vector3d(1., 1., 1.).normalize(),
    M_PI / 3.);
...
{
  cml::matrix33d M;
  cml::matrix_rotation_axis_angle(M, cml::vector3d(1., 1., 1.).normalize(),
    M_PI / 3.);
  cml::quaterniond q;
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_align(q, cml::vector3d(0., 0., 1.),
    cml::vector3d(1., 0., 0.));
  cml::matrix33d M;
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_aim_at(q, cml::vector3d(0., 0., 0.),
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_euler(q, cml::rad(90.), 0., 0.,
    cml::euler_order_xyz);
  cml::matrix33d M;
  cml::matrix_rotation_quaternion(M, q);
  auto v = M * cml::vector3d(0., 1., 0.);  // 0,0,1
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_euler(q, cml::vector3d(cml::rad(90.), 0., 0.),
    cml::euler_order_xyz);
  cml::matrix33d M;
  cml::matrix_rotation_quaternion(M, q);
  auto v = M * cml::vector3d(0., 1., 0.);  // 0,0,1
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_axis_angle(q, cml::vector3d(1., 2., 3.).normalize(),
    cml::rad(23.));
...
{
  cml::quaterniond q;
  cml::quaternion_rotation_euler(q, cml::rad(22.), cml::rad(10.),
    cml::rad(89.9), cml::euler_order_xyz);
...
CATCH_TEST_CASE("to_euler2")
{
  cml::quaterniond q;
  cml::quaternion_rotation_euler(q, cml::rad(22.), cml::rad(10.),
    cml::rad(89.9), cml::euler_order_xyx);
