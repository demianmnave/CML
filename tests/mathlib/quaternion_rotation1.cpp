...
CATCH_TEST_CASE("world_axis1")
{
  ...
  CATCH_CHECK(qx.real() == Approx(0.86602540378443871).epsilon(.001));
  CATCH_CHECK(qx.imaginary()[0] == Approx(0.49999999999999994).epsilon(.001));
  CATCH_CHECK(qx.imaginary()[1] == 0.);
  CATCH_CHECK(qx.imaginary()[2] == 0.);

  cml::quaterniond qy; cml::quaternion_rotation_world_y(qy, M_PI/2.);
  CATCH_CHECK(qy.real() == Approx(0.70710678118654757).epsilon(.001));
  CATCH_CHECK(qy.imaginary()[0] == 0.);
  CATCH_CHECK(qy.imaginary()[1] == Approx(0.70710678118654757).epsilon(.001));
  ...
  CATCH_CHECK(qz.imaginary()[2] == Approx(1.).epsilon(.001));
}
...
CATCH_TEST_CASE("axis_angle1")
{
  ...
  CATCH_CHECK(q.real() == Approx(0.86602540378443871).epsilon(.001));
  CATCH_CHECK(q.imaginary()[0] == Approx(0.28867513459481287).epsilon(.001));
  CATCH_CHECK(q.imaginary()[1] == Approx(0.28867513459481287).epsilon(.001));
  CATCH_CHECK(q.imaginary()[2] == Approx(0.28867513459481287).epsilon(.001));
}
