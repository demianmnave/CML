...
{
  using matrix_type = cml::matrix<double, cml::fixed<2, 2>>;
  {
...
{
  cml::matrix<double, cml::fixed<2, 2>> M1(1., 2., 3., 4.);
  cml::matrix<double, cml::fixed<2, 2>> M2(5., 6., 7., 8.);
...
CATCH_TEST_CASE("fixed, multiple_plus1")
{
  cml::matrix<double, cml::fixed<2, 2>> M1(1., 2., 3., 4.);
  cml::matrix<double, cml::fixed<2, 2>> M2(5., 6., 7., 8.);
  cml::matrix<double, cml::fixed<2, 2>> M3(9., 10., 11., 12.);
  cml::matrix<double, cml::fixed<2, 2>> M;
  M = M1 + M2 + M3;
  CATCH_REQUIRE(M.rows() == 2);
  CATCH_REQUIRE(M.cols() == 2);
...
{
  cml::matrix<double, cml::fixed<2, 2>> M1(5., 6., 7., 8.);
  cml::matrix<double, cml::fixed<2, 2>> M(1., 2., 3., 4.);
  M -= M1;
...
{
  cml::matrix<double, cml::dynamic<>> M1(2, 2, 1., 2., 3., 4.);
  cml::matrix<double, cml::dynamic<>> M2(2, 2, 5., 6., 7., 8.);
...
CATCH_TEST_CASE("dynamic, multiple_plus1")
{
  cml::matrix<double, cml::dynamic<>> M1(2, 2, 1., 2., 3., 4.);
  cml::matrix<double, cml::dynamic<>> M2(2, 2, 5., 6., 7., 8.);
  cml::matrix<double, cml::dynamic<>> M3(2, 2, 9., 10., 11., 12.);
  cml::matrix<double, cml::dynamic<>> M;
  M = M1 + M2 + M3;
  CATCH_REQUIRE(M.rows() == 2);
  CATCH_REQUIRE(M.cols() == 2);
...
{
  cml::matrix<double, cml::dynamic<>> M1(2, 2, 5., 6., 7., 8.);
  cml::matrix<double, cml::dynamic<>> M(2, 2, 1., 2., 3., 4.);
  M -= M1;
