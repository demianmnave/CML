...
{
  auto M = cml::matrix33d(2., 0., 2., 3., 3., 4., 5., 5., 4.);
  auto result = cml::determinant(M);
...
{
  auto M = cml::matrix44d(2., 0., 2., .6, 3., 3., 4., -2., 5., 5., 4., 2., -1.,
    -2., 3.4, -1.);
  auto result = cml::determinant(M);
...
{
  auto M = cml::matrix<double, cml::fixed<5, 5>>(2., 0., 2., .5, 2., 3., 3., 4.,
    -2., -1., 5., 5., 4., 2., 1., -1., -2., 3., -1., 5., 1., 6., 7., .5, 1.);
  auto result = cml::determinant(M);
...
{
  double avM[] = {
    2., 0., 2., .6, 3., 3., 4., -2., 5., 5., 4., 2., -1., -2., 3.4, -1.};
...
{
  double avM[] = {2., 0., 2., .5, 2., 3., 3., 4., -2., -1., 5., 5., 4., 2., 1.,
    -1., -2., 3., -1., 5., 1., 6., 7., .5, 1.};
...
{
  auto M = cml::matrixd(2, 2, 2., -1., 3., 3.);
  auto result = cml::determinant(M);
  CATCH_CHECK(result == Approx(9).epsilon(1e-12));
}
...
{
  auto M = cml::matrixd(3, 3, 2., 0., 2., 3., 3., 4., 5., 5., 4.);
  auto result = cml::determinant(M);
  CATCH_CHECK(result == Approx(-16).epsilon(1e-12));
}
...
{
  auto M = cml::matrixd(4, 4, 2., 0., 2., .6, 3., 3., 4., -2., 5., 5., 4., 2.,
    -1., -2., 3.4, -1.);
  auto result = cml::determinant(M);
  CATCH_CHECK(result == Approx(-120).epsilon(1e-12));
}
...
{
  auto M = cml::matrix<double, cml::dynamic<>>(5, 5, 2., 0., 2., .5, 2., 3., 3.,
    4., -2., -1., 5., 5., 4., 2., 1., -1., -2., 3., -1., 5., 1., 6., 7., .5,
    1.);
  auto result = cml::determinant(M);
  CATCH_CHECK(result == Approx(464).epsilon(1e-12));
}
