...
template<class T> using storage_type_of_t = typename storage_type_of<T>::type;
...
{
  using type = typename T::proxy_type;
};
...
template<class T>
using rebind_vector_storage_t = typename rebind_vector_storage<T>::type;
...
template<class T>
using rebind_matrix_storage_t = typename rebind_matrix_storage<T>::type;
...
template<class T>
using rebind_quaternion_storage_t = typename rebind_quaternion_storage<T>::type;
