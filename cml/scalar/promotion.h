 ...
 * combining N scalars.
 */
template<class... Scalars> using scalar_promote = std::common_type<Scalars...>;

/** Use C++ type deduction via std::common_type to determine the result of
 * combining N scalars.
 */
template<class... Scalars>
using scalar_promote_t = typename scalar_promote<Scalars...>::type;
...
template<class... Subs>
using value_type_promote_t = typename value_type_promote<Subs...>::type;
