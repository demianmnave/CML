...
inverse(writable_matrix<Sub>& M, int_c<4>)
{
  ...
  auto d02 = M(1, 0) * -m_23_31_21_33 + M(1, 1) * m_23_30_20_33
    + M(1, 3) * m_20_31_21_30;
  auto d03 = M(1, 0) * m_21_32_22_31 + M(1, 1) * -m_20_32_22_30
    + M(1, 2) * m_20_31_21_30;
  ...
  auto d12 = M(0, 0) * -m_23_31_21_33 + M(0, 1) * m_23_30_20_33
    + M(0, 3) * m_20_31_21_30;
  auto d13 = M(0, 0) * m_21_32_22_31 + M(0, 1) * -m_20_32_22_30
    + M(0, 2) * m_20_31_21_30;
  ...
  auto d22 = M(3, 0) * -m_03_11_01_13 + M(3, 1) * m_03_10_00_13
    + M(3, 3) * m_00_11_01_10;
  auto d23 = M(3, 0) * m_01_12_02_11 + M(3, 1) * -m_00_12_02_10
    + M(3, 2) * m_00_11_01_10;
  ...
  auto d32 = M(2, 0) * -m_03_11_01_13 + M(2, 1) * m_03_10_00_13
    + M(2, 3) * m_00_11_01_10;
  auto d33 = M(2, 0) * m_01_12_02_11 + M(2, 1) * -m_00_12_02_10
    + M(2, 2) * m_00_11_01_10;
  ...
  ColIndexArray& col_index, Markers& pivoted)
{
  ...
  for(int i = 0; i < N; ++i) {
    ...
    if(row != col) {
      for(int j = 0; j < N; ++j) std::swap(M(row, j), M(col, j));
    }
