...
trace_2x2(writable_matrix<Sub>& m) -> value_type_trait_of_t<Sub>
{
...
template<class Sub> auto
trace_3x3(writable_matrix<Sub>& m) -> value_type_trait_of_t<Sub>
{
...
template<class Sub1, class Scalar> void
