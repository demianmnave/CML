...
void matrix_scale_2D(writable_matrix<Sub>& m, const E0& e0, const E1& e1);
...
void matrix_scale_2D(writable_matrix<Sub1>& m, const readable_vector<Sub2>& v);
...
void matrix_uniform_scale_2D(writable_matrix<Sub>& m, const E0& e0);
 ...
 */
template<class Sub, class E0, class E1>
void matrix_inverse_scale_2D(writable_matrix<Sub>& m, const E0& e0,
  const E1& e1);
 ...
 */
template<class Sub1, class Sub2>
void matrix_inverse_scale_2D(writable_matrix<Sub1>& m,
...
void matrix_scale(writable_matrix<Sub>& m, const E0& e0, const E1& e1,
  const E2& e2);
 ...
 */
template<class Sub1, class Sub2>
void matrix_scale(writable_matrix<Sub1>& m, const readable_vector<Sub2>& v);
 ...
 */
template<class Sub, class E0>
void matrix_uniform_scale(writable_matrix<Sub>& m, const E0& e0);
 ...
 */
template<class Sub, class E0, class E1, class E2>
void matrix_inverse_scale(writable_matrix<Sub>& m, const E0& e0, const E1& e1,
  const E2& e2);
 ...
 */
template<class Sub1, class Sub2>
void matrix_inverse_scale(writable_matrix<Sub1>& m,
  const readable_vector<Sub2>& v);
