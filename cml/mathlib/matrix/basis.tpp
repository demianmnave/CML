  ...
  -> n_basis_vector_of_t<Sub, 2>
{
  cml::check_linear_2D(m);
  cml_require(0 <= i && i <= 1, std::invalid_argument, "invalid 2D index");
  return n_basis_vector_of_t<Sub, 2>(m.basis_element(i, 0),
    m.basis_element(i, 1));
}
  ...
  -> n_basis_vector_of_t<Sub, 2>
{
  cml::check_linear_2D(m);
  cml_require(0 <= i && i <= 1, std::invalid_argument, "invalid 2D index");
  return n_basis_vector_of_t<Sub, 2>(m.basis_element(0, i),
    m.basis_element(1, i));
}
  ...
  -> n_basis_vector_of_t<Sub, 3>
{
  cml::check_linear_3D(m);
  cml_require(0 <= i && i <= 2, std::invalid_argument, "invalid 3D index");
  return n_basis_vector_of_t<Sub, 3>(m.basis_element(i, 0),
    m.basis_element(i, 1), m.basis_element(i, 2));
}
  ...
  -> n_basis_vector_of_t<Sub, 3>
{
  cml::check_linear_3D(m);
  cml_require(0 <= i && i <= 2, std::invalid_argument, "invalid 3D index");
  return n_basis_vector_of_t<Sub, 3>(m.basis_element(0, i),
    m.basis_element(1, i), m.basis_element(2, i));
}
