...
inline auto
identity_2x2() -> decltype(identity<2, 2>())
{
  return identity<2, 2>();
}
...
inline auto
identity_3x3() -> decltype(identity<3, 3>())
{
  return identity<3, 3>();
}
...
inline auto
identity_4x4() -> decltype(identity<4, 4>())
{
  return identity<4, 4>();
}
