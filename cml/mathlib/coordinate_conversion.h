...
using SphericalType = LatitudeType;
...
void polar_to_cartesian(writable_vector<Sub>& v, E0 radius, E1 theta);

/** For CML1 compatibility. */
template<class E, class Sub>
void polar_to_cartesian(E radius, E theta, writable_vector<Sub>& v);
...
void cylindrical_to_cartesian(writable_vector<Sub>& v, int axis, E0 radius,
  E1 theta, E2 height);

/** For CML1 compatibility. */
template<class E, class Sub>
void cylindrical_to_cartesian(E radius, E theta, E height, int axis,
 ...
 */
template<class Sub, class E0, class E1, class E2>
void spherical_to_cartesian(writable_vector<Sub>& v, int axis,
  LatitudeType type, E0 radius, E1 theta, E2 phi);

/** For CML1 compatibility. */
template<class E, class Sub>
void spherical_to_cartesian(E radius, E theta, E phi, int axis,
  LatitudeType type, writable_vector<Sub>& v);
 ...
 */
template<class Sub, class E0, class E1>
void cartesian_to_polar(const readable_vector<Sub>& v, E0& radius, E1& theta);
 ...
 */
template<class Sub, class E0, class E1, class E2>
void cartesian_to_cylindrical(const readable_vector<Sub>& v, int axis,
  E0& radius, E1& theta, E2& height);
...
void cartesian_to_cylindrical(const readable_vector<Sub>& v, int axis,
  E0& radius, E1& theta, E2& height, Tol tolerance);

/** For compatibility with CML1. */
template<class Sub, class E>
void cartesian_to_cylindrical(const readable_vector<Sub>& v, E& radius,
  E& theta, E& height, int axis,
 ...
 */
template<class Sub, class E0, class E1, class E2>
void cartesian_to_spherical(const readable_vector<Sub>& v, int axis,
  LatitudeType type, E0& radius, E1& theta, E2& phi);
...
/** For compatibility with CML1. */
template<class Sub, class E>
void cartesian_to_spherical(const readable_vector<Sub>& v, E& radius, E& theta,
  E& phi, int axis, LatitudeType type,
  E tolerance = scalar_traits<E>::sqrt_epsilon());
