  ...
  -> temporary_of_t<decltype(q.imaginary())>
{
  ...
  using result_type = temporary_of_t<decltype(q.imaginary())>;
...
template<class Sub, class XBasis, class YBasis, class ZBasis,
  enable_if_vector_t<XBasis>*, enable_if_vector_t<YBasis>*,
  enable_if_vector_t<ZBasis>*>
void
quaternion_get_basis_vectors(const readable_quaternion<Sub>& q, XBasis& x,
  YBasis& y, ZBasis& z)
{
