...
void quaternion_rotation_world_axis(writable_quaternion<Sub>& q, int axis,
  E angle);

/** Build a quaternion representing a rotation about world x-axis. */
template<class Sub, class E>
void quaternion_rotation_world_x(writable_quaternion<Sub>& q, E angle);

/** Build a quaternion representing a rotation about world y-axis. */
template<class Sub, class E>
void quaternion_rotation_world_y(writable_quaternion<Sub>& q, E angle);

/** Build a quaternion representing a rotation about world z-axis. */
template<class Sub, class E>
void quaternion_rotation_world_z(writable_quaternion<Sub>& q, E angle);
...
void quaternion_rotation_axis_angle(writable_quaternion<Sub>& q,
...
void quaternion_rotation_matrix(writable_quaternion<Sub>& q,
...
void quaternion_rotation_euler(writable_quaternion<Sub>& q, E0 angle_0,
...
void quaternion_rotation_euler(writable_quaternion<Sub>& q,
...
void quaternion_rotation_align(writable_quaternion<Sub>& q,
...
void quaternion_rotation_aim_at(writable_quaternion<Sub>& q,
 ...
 */
template<class Sub, class ASub, class E, class Tol = value_type_trait_of_t<Sub>>
void quaternion_to_axis_angle(const readable_quaternion<Sub>& q,
...
void quaternion_to_euler(const readable_quaternion<Sub>& q, E0& angle_0,
  E1& angle_1, E2& angle_2, euler_order order,
  Tol tolerance = scalar_traits<Tol>::epsilon(),
 ...
 */
template<class Sub, class Tol = value_type_trait_of_t<Sub>>
vector<value_type_trait_of_t<Sub>, compiled<3>> quaternion_to_euler(
...
VectorT quaternion_to_euler(const readable_quaternion<Sub>& q,
  euler_order order, Tol tolerance = scalar_traits<Tol>::epsilon(),
