...
{
  using result_type = temporary_of_t<Sub2>;
  using value_type = value_type_trait_of_t<result_type>;
  ...
  -> temporary_of_t<Sub2>
{
  ...
  return result_type(
    ...
    value_type(m.basis_element(0, 2) * v[0] + m.basis_element(1, 2) * v[1]
  ...
  const readable_vector<Sub2>& v) -> temporary_of_t<Sub2>
{
  ...
  vector<value_type, compiled<4>> h(
    ...
    value_type(m.basis_element(0, 3) * v[0] + m.basis_element(1, 3) * v[1]
      + m.basis_element(2, 3) * v[2] + m.basis_element(3, 3)));
