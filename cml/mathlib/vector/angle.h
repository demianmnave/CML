...
inline auto signed_angle_2D(const readable_vector<Sub1>& v1,
...
inline auto unsigned_angle_2D(const readable_vector<Sub1>& v1,
  const readable_vector<Sub2>& v2) -> value_type_trait_promote_t<Sub1, Sub2>;
 ...
 */
template<class Sub1, class Sub2, class Sub3>
inline auto signed_angle(const readable_vector<Sub1>& v1,
  const readable_vector<Sub2>& v2, const readable_vector<Sub3>& reference)
  -> value_type_trait_promote_t<Sub1, Sub2, Sub3>;

/** Unsigned angle between two 3D vectors @c v1 and @c v2. */
template<class Sub1, class Sub2>
inline auto unsigned_angle(const readable_vector<Sub1>& v1,
  const readable_vector<Sub2>& v2) -> value_type_trait_promote_t<Sub1, Sub2>;
