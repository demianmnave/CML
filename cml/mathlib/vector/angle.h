...
auto signed_angle_2D(const readable_vector<Sub1>& v1,
...
auto unsigned_angle_2D(const readable_vector<Sub1>& v1,
  const readable_vector<Sub2>& v2) -> value_type_trait_promote_t<Sub1, Sub2>;
 ...
 */
template<class Sub1, class Sub2, class Sub3>
auto signed_angle(const readable_vector<Sub1>& v1,
...
template<class Sub1, class Sub2>
auto unsigned_angle(const readable_vector<Sub1>& v1,
  const readable_vector<Sub2>& v2) -> value_type_trait_promote_t<Sub1, Sub2>;
