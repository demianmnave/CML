...
void orthonormal_basis_2D(const readable_vector<Sub>& align,
...
void orthonormal_basis(const readable_vector<Sub1>& align,
  const readable_vector<Sub2>& reference, writable_vector<XSub>& x,
  writable_vector<YSub>& y, writable_vector<ZSub>& z,
