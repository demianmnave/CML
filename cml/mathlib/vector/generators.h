...
inline auto
axis_2D(int i) -> decltype(axis<2>(i))
{
  return axis<2>(i);
}
...
inline auto
axis_3D(int i) -> decltype(axis<3>(i))
{
  return axis<3>(i);
}
