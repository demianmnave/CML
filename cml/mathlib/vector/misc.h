...
auto project_to_vector(const readable_vector<Sub1>& u,
 ...
 */
template<class Sub1, class Sub2>
auto project_to_hplane(const readable_vector<Sub1>& v,
 ...
 */
template<class Sub>
auto perp(const readable_vector<Sub>& v) -> temporary_of_t<Sub>;
 ...
 */
template<class Sub1, class Sub2>
auto manhattan_distance(const readable_vector<Sub1>& v1,
