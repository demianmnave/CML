...
class writable_vector : public readable_vector<DerivedT>
{
  ...
  DerivedT& minimize(const readable_vector<OtherDerivedT>& other) __CML_REF;
  ...
  /** Set the vector to the pairwise minimum elements with @c other.
     ...
     */
  template<class OtherDerivedT>
  DerivedT& maximize(const readable_vector<OtherDerivedT>& other) __CML_REF;
  ...
  auto set(const E0& e0, const Elements&... eN) __CML_REF->enable_if_t<
  ...
  /** Assign from a readable_vector.
     ...
     */
  template<class OtherDerivedT>
  DerivedT& operator=(const readable_vector<OtherDerivedT>& other) __CML_REF;
