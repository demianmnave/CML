...
template<class DT>
DT&
writable_vector<DT>::random(const_reference low, const_reference high) __CML_REF
{
...
template<class E0, class... Es>
auto
writable_vector<DT>::set(const E0& e0, const Es&... eN) && -> enable_if_t<
  are_convertible<value_type, E0, Es...>::value, DT&&>
{
...
template<class ScalarT,
  enable_if_convertible_t<typename vector_traits<DT>::value_type, ScalarT>*>
DT&
...
template<class DT>
template<class ODT, class... Es>
DT&
writable_vector<DT>::assign(const readable_vector<ODT>& other, const Es&... eN)
{
