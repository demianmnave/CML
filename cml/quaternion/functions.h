...
template<class DerivedT>
auto length_squared(const readable_quaternion<DerivedT>& q)
  -> value_type_trait_of_t<DerivedT>;

/** Return the length of @c q. */
template<class DerivedT>
auto length(const readable_quaternion<DerivedT>& q)
  -> value_type_trait_of_t<DerivedT>;

/** Return the Cayley norm (squared length) of @c q. */
template<class DerivedT>
auto norm(const readable_quaternion<DerivedT>& q)
  -> value_type_trait_of_t<DerivedT>;

/** Return a normalized copy of @c q. */
template<class DerivedT>
auto normalize(const readable_quaternion<DerivedT>& q)
  -> temporary_of_t<DerivedT>;

/** Return the multiplicative identity of quaternion @c q. */
template<class DerivedT>
auto identity(const readable_quaternion<DerivedT>& q)
  -> temporary_of_t<DerivedT>;

/** Return the log of @c q. */
template<class DerivedT>
auto log(const readable_quaternion<DerivedT>& q) -> temporary_of_t<DerivedT>;
