...
class writable_quaternion : public readable_quaternion<DerivedT>
{
  ...
  auto set(const readable_vector<Sub>& v, const E& s) __CML_REF->enable_if_t<
  ...
  auto set(const E& s, const readable_vector<Sub>& v) __CML_REF->enable_if_t<
    are_convertible<value_type, value_type_trait_of_t<Sub>, E>::value,
    DerivedT&>;
...
#  endif
  ...
  DerivedT& operator=(
    const readable_quaternion<OtherDerivedT>& other) __CML_REF;
