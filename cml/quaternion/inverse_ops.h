...
#ifndef	cml_quaternion_inverse_ops_h
#define	cml_quaternion_inverse_ops_h
 ...
 */
template<class Sub> auto inverse(const readable_quaternion<Sub>& q)
 ...
 */
template<class Sub> auto inverse(readable_quaternion<Sub>&& q)
-> inverse_node<Sub&&>;
