...
using quaternionf_ip = quaternion<float, fixed<>, imaginary_first,
  positive_cross>;
using quaternionf_p = quaternion<float, fixed<>, imaginary_first,
  positive_cross>;
using quaternionf = quaternion<float>;

using quaterniond_ip = quaternion<double, fixed<>, imaginary_first,
  positive_cross>;
using quaterniond_p = quaternion<double, fixed<>, imaginary_first,
  positive_cross>;
using quaterniond = quaternion<double>;


// Imaginary first, negative cross:
using quaternionf_in = quaternion<float, fixed<>, imaginary_first,
  negative_cross>;
using quaternionf_n = quaternion<float, fixed<>, imaginary_first,
  negative_cross>;

using quaterniond_in = quaternion<double, fixed<>, imaginary_first,
  negative_cross>;
using quaterniond_n = quaternion<double, fixed<>, imaginary_first,
  negative_cross>;
