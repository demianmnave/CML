...
inline et::QuaternionXpr<                                                \
    et::UnaryQuaternionOp< quaternion<VecT,OrderT,CrossT>,               \
    _OpT_ <typename VecT::value_type> >                                  \
>                                                                        \
                                                                         \
_op_ (const quaternion<VecT,OrderT,CrossT>& arg)                         \
{                                                                        \
    typedef et::UnaryQuaternionOp<                                       \
            quaternion<VecT,OrderT,CrossT>,                              \
            _OpT_ <typename VecT::value_type>                            \
        > ExprT;                                                         \
...
template<typename VecT1, typename VecT2,                                 \
    typename OrderT, typename CrossT>                                    \
inline et::QuaternionXpr<                                                \
...
inline et::QuaternionXpr<                                                \
    et::BinaryQuaternionOp<                                              \
        quaternion<VecT,OrderT,CrossT>, XprT,                            \
...
inline et::QuaternionXpr<                                                \
    et::BinaryQuaternionOp<                                              \
        XprT, quaternion<VecT,OrderT,CrossT>,                            \
...
inline et::QuaternionXpr<                                                \
    et::BinaryQuaternionOp<                                              \
        quaternion<VecT,OrderT,CrossT>, ScalarT,                         \
...
inline et::QuaternionXpr<                                                \
    et::BinaryQuaternionOp<                                              \
        ScalarT, quaternion<VecT,OrderT,CrossT>,                         \
