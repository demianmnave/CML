...
inline et::QuaternionXpr<                                                \
    et::UnaryQuaternionOp< quaternion<VecT>,                             \
    _OpT_ <typename VecT::value_type> >                                  \
>                                                                        \
                                                                         \
_op_ (const quaternion<VecT>& arg)                                       \
{                                                                        \
    typedef et::UnaryQuaternionOp<                                       \
            quaternion<VecT>, _OpT_ <typename VecT::value_type>          \
        > ExprT;                                                         \
