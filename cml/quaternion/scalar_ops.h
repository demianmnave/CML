...
#ifndef	cml_quaternion_scalar_ops_h
#define	cml_quaternion_scalar_ops_h
...
> inline auto
make_quaternion_scalar_node(Sub&& sub, Scalar&& v)
-> quaternion_scalar_node<
...
>
{
  ...
  return quaternion_scalar_node<sub_type, scalar_type, Op>(
